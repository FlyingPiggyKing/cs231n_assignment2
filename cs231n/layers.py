...
def affine_backward(dout, cache):
    ...
    dims = x.shape[1:]
    xr = np.reshape(x, (x.shape[0], np.prod(dims))).T #x.shape[1]*x.shape[2]*x.shape[3]
    dw = np.dot(xr, dout).reshape(w.shape)
...
def relu_backward(dout, cache):
    ...
    ###########################################################################
    intermediate = np.ones(x.shape)
    intermediate[x < 0] = 0
    #print(('intermediate: ', intermediate))
    dx = intermediate * dout
    #print(('dx: ', dx))
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
...
def svm_loss(x, y):
    ...
    #print(('margins1: ', margins))
    margins[np.arange(N), y] = 0
    #print(('margins2: ', margins))
